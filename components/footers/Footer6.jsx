    ...
    <div className="container">
      <div className="row pb-120 pb-sm-80 pb-xs-50">
        <div className="col-lg-3 text-gray mb-md-50">
          <div className="mb-30">
            <h5>Heat Pump Rebates Ontario</h5>
          </div>
          <p>
            Ontario Heat Pump Rebates specializes in high-efficiency heating and
            cooling solutions, assisting homeowners across Ontario with
            obtaining significant rebates and expert installation services.
          </p>
          <div className="clearlinks">
            <strong>T.</strong>
            <a href="tel:+18884071636 ">+1 888 407 1636 </a>
          </div>
          <div className="clearlinks">
            <strong>E.</strong>
            <a href="mailto:info@ontarioheatpumprebates.ca">
              info@ontarioheatpumprebates.ca
            </a>
          </div>
        </div>
